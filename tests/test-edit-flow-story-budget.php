...
class WP_Test_Edit_Flow_Story_Budget extends WP_UnitTestCase {
	 ...
	 */
	function test_story_budget_set_start_date_filter() {
        global $edit_flow;
	 ...
	 */
	function test_story_budget_set_start_date_filter_invalid() {
        global $edit_flow;
	 ...
	 */
	function test_story_budget_set_number_days_filter() {
        global $edit_flow;
	 ...
	 */
	function test_story_budget_set_date_and_number_days_filters() {
        global $edit_flow;
